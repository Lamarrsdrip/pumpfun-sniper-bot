...
export default function DiscoverScreen() {
  ...
  return <Page>
    ...
    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}><Text style={{ color: dark.text, fontSize: 19, fontWeight: '900' }}>{active}</Text><Text style={{ color: dark.green, fontSize: 12, fontWeight: '800' }}>LIVE SCAN</Text></View>
