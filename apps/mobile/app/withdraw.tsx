...
export default function Withdraw() {
  ...
  return <ScrollView style={{ flex: 1, backgroundColor: dark.background }} contentContainerStyle={{ padding: spacing.md, gap: 12 }}><Text style={styles.title}>Withdraw money</Text><Text style={styles.body}>Send Naira to your verified bank or withdraw supported crypto.</Text><View style={{ flexDirection: 'row', gap: 9 }}><Pressable style={{ flex: 1, padding: 14, borderRadius: 10, backgroundColor: dark.greenSoft, borderWidth: 1, borderColor: dark.green }}><Text style={{ color: dark.green, fontWeight: '900' }}>Nigerian bank</Text></Pressable><Pressable onPress={() => router.push('/crypto-withdraw')} style={{ flex: 1, padding: 14, borderRadius: 10, backgroundColor: dark.surface }}><Text style={{ color: dark.text, fontWeight: '900' }}>Crypto wallet</Text></Pressable></View><Card>
