...
const styles = StyleSheet.create({
  ...
  pageContent: { paddingHorizontal: spacing.md, paddingTop: spacing.sm, gap: 17, paddingBottom: 52 },
  ...
  headerIcon: { width: 43, height: 43, borderRadius: 15, backgroundColor: dark.surface, alignItems: 'center', justifyContent: 'center' },
  ...
  avatar: { width: 43, height: 43, borderRadius: 15, backgroundColor: dark.greenSoft, alignItems: 'center', justifyContent: 'center' },
  avatarText: { color: dark.green, fontWeight: '900' },
  card: { backgroundColor: dark.surface, borderRadius: radius.xl, padding: spacing.md, borderCurve: 'continuous', boxShadow: depth.soft },
  ...
  statusPill: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 8, paddingVertical: 5, borderRadius: 99 },
