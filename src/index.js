...
import { PaperBroker, DisabledLiveBroker } from './broker.js';
...
const broker = config.mode === 'live' ? new DisabledLiveBroker() : new PaperBroker(config.paperStartingSol);
...
console.log(`Mode: ${config.mode}. Data: ${config.dataMode}. Live execution is disabled until you implement a broker.`);
